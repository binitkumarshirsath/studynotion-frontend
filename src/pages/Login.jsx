...
function Login() {
  ...
  const InstructorMail = import.meta.env.VITE_INSTRUCTOR_MAIL;
  const InstructorPass = import.meta.env.VITE_INSTRUCTOR_PASS;
  const StudentMail = import.meta.env.VITE_STUDENT_MAIL;
  ...
  return (
    <>
      ...
      <div
        className={`${
          showDemo ? "" : "hidden"
        } justify-center items-center absolute  bg-richblack-400 top-52 md:top-32 md:right-[50%] right-[10%] p-6 -rotate-[20deg] z-20 gradient-border`}
      >
        <div className="flex flex-col gap-2 relative">
          ...
          <div className=" gap-y-2 flex flex-col">
            ...
            <div>
              <button
                onClick={() => {
                  dispatch(login(InstructorMail, InstructorPass, navigate));
                }}
            ...
            <div>
              <button
                onClick={() => {
                  dispatch(login(StudentMail, StudentPass, navigate));
                }}
